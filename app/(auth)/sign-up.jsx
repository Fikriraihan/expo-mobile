    ...
    <SafeAreaView className="bg-primary h-full">
      <ScrollView>
        <View className="w-full justify-center min-h-[83vh] px-4 my-6">
          ...
          <Text className="text-xl text-white text-semibold font-psemibold mt-10">Sign up to Aora</Text>
          ...
          <View className="justify-center pt-5 flex-row gap-2">
            ...
            <Link href="/sign-in" className="text-secondary text-lg font-psemibold ">
              Sign In
            </Link>
          </View>
        </View>
